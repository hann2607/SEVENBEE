					...
					<div class="row">
						...
						<div class="col-lg-3 col-md-4">
							<div class="header-top-left">
								<ul class="phone-wrap">
									<li><span>HOTLINE: </span><a href="#">(+84) 9847 724
											10</a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-8">
							<div class="header-top-right">
								<ul class="ht-menu">
									<!-- Begin Language Area -->
									<li><span class="language-selector-wrapper">NGÔN
											NGỮ :</span>
									...
									<!-- Begin Currency Area -->
									<li><span class="currency-selector-wrapper">TIỀN TỆ
											:</span>
					...
					<div class="col-lg-12">
						<div class="error-wrapper text-center ptb-50 pt-xs-20">
							<div class="error-text">
								...
								<p>
									Xin lỗi nhưng trang bạn đang tìm kiếm không tồn tại, có thể đã
									bị loại bỏ, <br> tên đã thay đổi hoặc tạm thời không khả
									dụng.
								</p>
							</div>
					...
					<div class="footer-shipping pt-60 pb-25">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/views/images/shipping-icon/1.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
										<h2>Miễn phí vận chuyển</h2>
										<p>Giao và trả hàng hoàn toàn miễn phí, giao hàng nhanh và
											toàn quốc.</p>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/views/images/shipping-icon/2.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
										<h2>Thanh toán an toàn</h2>
										<p>Thanh toán bằng các phương thức thanh toán phổ biến và
											an toàn nhất thế giới.</p>
									</div>
								</div>
							</div>
							<!-- Li's Shipping Inner Box Area End Here -->
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/views/images/shipping-icon/3.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
										<h2>Mua sắm với sự tin tưởng</h2>
										<p>Bảo vệ người mua bao gồm giao dịch mua của bạn từ nhấp
											chuột đến giao hàng.</p>
									</div>
								</div>
							</div>
							<!-- Li's Shipping Inner Box Area End Here -->
							...
							<div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
								<div class="li-shipping-inner-box">
									<div class="shipping-icon">
										<img src="/views/images/shipping-icon/4.png"
											alt="Shipping Icon">
									</div>
									<div class="shipping-text">
										<h2>Trung tâm hỗ trợ 24/7</h2>
										<p>Nếu bạn có câu hỏi? Hãy gọi cho chuyên gia hoặc trò
											chuyện trực tuyến.</p>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6">
								<div class="footer-logo">
									<a href="https://linktr.ee/sevenbee.com"> <img
										src="/views/images/menu/logo/logo-final-black-footer.png"
										alt="Footer Logo"></a>
								...
								<ul class="des">
									...
									<li><span>ĐIỆN THOẠI: </span> <a href="#">(+84) 9847
											724 10</a></li>
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="copyright text-center">
								<a href="#"> <img src="/views/images/payment/1.png" alt="">
								</a>
							</div>
							...
							<div class="copyright text-center pt-25">
								<span><a target="_blank"
									href="https://linktr.ee/sevenbee.com">Copyright &copy; 2023
										SEVENBEE.COM</a></span>
							</div>
