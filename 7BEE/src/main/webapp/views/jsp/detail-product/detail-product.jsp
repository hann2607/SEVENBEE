                                        ...
                                        <div class="language ht-language">
                                            <ul class="ht-setting-list">
                                                <li class="active"><a href="#"><img src="images/menu/flag-icon/1.jpg"
                                                            alt="">TIẾNG ANH</a></li>
                                                <li><a href="#"><img src="images/menu/flag-icon/2.png" alt="">TIẾNG
                                                        VIỆT</a></li>
                                            </ul>
                                        </div>
                                    </li>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-lg-3">
                            <div class="logo pb-sm-30 pb-xs-30">
                                <a href="index.html">
                                    <img src="images/menu/logo/logo-final.png" alt="">
                                </a>
                            </div>
                        </div>
                                ...
                                <ul class="hm-menu">
                                    ...
                                    <li class="hm-minicart">
                                        ...
                                        <div class="minicart">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="minicart-product-details">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <span>x 1</span>
                                                            <div><span>40000000</span><span> VNĐ</span></div>
                                                        </div>
                                            ...
                                            <h6 class="my-3 d-flex justify-content-between">TỔNG TIỀN: <div>
                                                    <span>8000000</span><span> VNĐ</span></div>
                                            </h6>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="hb-menu">
                                <nav>
                                    <ul>
                                        <li><a class="clearafter" href="index.html">TRANG CHỦ</a></li>
                                    ...
                                    <li class="dropdown-holder"><a href="blog-left-sidebar.html">TIN TỨC</a>
                                        <ul class="hb-dropdown">
                                            <li><a class="clearafter" href="blog-left-sidebar.html">TIN TỨC MỚI NHẤT</a> </li>
                                            <hr class="my-2">
                                            <li><a class="clearafter" href="blog-left-sidebar.html">TIN TỨC CỦA TÔI</a></li>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="product-details-view-content sp-normal-content pt-60">
                                <div class="product-info">
                                    ...
                                    <span class="product-details-ref">Tên Shop...</span>
                            ...
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-between align-items-center  ">
                                 <span class="font-weight-bold">Mã Sản phẩm</span>
                                  <span class="">PH021</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="font-weight-bold"> Lượt Mua</span>
                                    <span class="">261</span>
                                  </li>
                                  <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <span class="font-weight-bold"> Kích Thước </span>
                                    <span class="">36.02 x 23.4 x 1.79 cm</span>
                                  </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <span class="font-weight-bold"> Màu</span>
                                  <span class="">Đen</span>
                                    </li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        <img src="images/menu/logo/logo-final-black-footer.png" alt="Footer Logo">
                                        <p class="info">
