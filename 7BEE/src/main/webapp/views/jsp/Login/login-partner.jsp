			...
			<div class="container">
				<div class="breadcrumb-content">
					<ul>
						...
						<li class="active">Đăng nhập dành cho Partner</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
						<!-- Login Form s-->
						<form:form modelAttribute="partnerLog">
							<div class="login-form">
								<h4 class="login-title">Đăng nhập dành cho Partner</h4>
								<div class="row">
									...
									<div class="col-md-12">
										<button formaction="/partner/login"
					...
					<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
						<form:form modelAttribute="partner">
							<div class="login-form">
								<h4 class="login-title">Đăng ký tài khoản Partner</h4>
								<div class="row">
									<div class="col-md-6 col-12 mb-20">
										<form:label path="Shop_TenShop">Tên shop</form:label>
										<form:input path="Shop_TenShop" class="mb-0" type="text" />
										<form:errors path="Shop_TenShop" class="badge badge-danger" />
									</div>
									<div class="col-md-6 col-12 mb-20">
									...
									<div class="col-md-6 mb-20">
										<label>Xác nhận mật khẩu</label><input class="mb-0" name="XacnhanMatkhau"
											type="password">
										<c:if test="${not empty XNMatkhau}">
											<!-- Nếu hai trường mật khẩu không giống nhau, hiển thị thông báo lỗi tại đây -->
											<div class="badge badge-danger">${XNMatkhau}</div>
										</c:if>
									</div>
									<div class="col-12">
										<button formaction="/partner/createPartner"
