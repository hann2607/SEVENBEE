						...
						<div
							...
							<div class="slider-content">
								...
								<div class="default-btn slide-btn">
									<a class="links" href="/views/shop-left-sidebar.html">MUA NGAY</a>
								</div>
							</div>
						</div>
					...
					<div class="product-active owl-carousel">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="/views/single-product.html"> <img
										src="/views/images/product/large-size/1.jpg" alt="Li's Product Image">
								...
								<div class="product_desc">
									<div class="product_desc_info">
										...
										<h4>
											<a class="product_name" href="/views/single-product.html">Accusantium
												dolorem1</a>
										</h4>
										<div class="price-box">
											<span class="new-price">100000</span><span> VNĐ</span>
										</div>
									</div>
									<div class="add-actions">
										<ul class="add-actions-link">
											<li class="add-cart active"><a href="#">THÊM VÀO GIỎ</a></li>
											<li><a class="links-details" href="/views/single-product.html"><i
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="/views/single-product.html"> <img
										src="/views/images/product/large-size/2.jpg" alt="Li's Product Image">
									</a> <span class="sticker">MỚI</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
										<div class="product-review">
											<h5 class="manufacturer">
												<a href="/views/product-details.html">Studio Design</a>
											</h5>
											<div class="rating-box">
												<ul class="rating">
													<li><i class="fa fa-star-o"></i></li>
										...
										<h4>
											<a class="product_name" href="/views/single-product.html">Mug
												Today is a good day</a>
										</h4>
										<div class="price-box">
											<span class="new-price new-price-2">1000</span> <span
												class="old-price">500</span> <span>VNĐ</span> <span
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="/views/single-product.html"> <img
										src="/views/images/product/large-size/3.jpg" alt="Li's Product Image">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="/views/single-product.html"> <img
										src="/views/images/product/large-size/4.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="/views/single-product.html"> <img
										src="/views/images/product/large-size/5.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
										...
										<h4>
											<a class="product_name" href="single-product.html">Accusantium
												dolorem1</a>
										</h4>
										<div class="price-box">
											<span class="new-price">$46.80</span>
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/6.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
										...
										<h4>
											<a class="product_name" href="single-product.html">Mug
												Today is a good day</a>
										</h4>
										<div class="price-box">
											<span class="new-price new-price-2">$71.80</span> <span
					...
					<div class="product-active owl-carousel">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/9.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/8.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/7.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
					...
					<div class="product-active owl-carousel">
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/3.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/5.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="single-banner pb-sm-30 pb-xs-30">
					<a href="#"> <img src="images/banner/2_3.jpg"
			...
			<div class="col-lg-6">
				<div class="single-banner">
					<a href="#"> <img src="images/banner/2_4.jpg"
						alt="Li's Static Banner">
					</a>
				</div>
			</div>
					...
					<div class="product-active owl-carousel">
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/1.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/2.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
						...
						<div class="col-lg-12">
							...
							<div class="single-product-wrap">
								<div class="product-image">
									<a href="single-product.html"> <img
										src="images/product/large-size/4.jpg" alt="Li's Product Image">
									</a> <span class="sticker">New</span>
								</div>
								<div class="product_desc">
									<div class="product_desc_info">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="li-static-home-content">
					...
					<p class="schedule">
						Giá chỉ từ <span> 10000</span> <span> VNĐ</span>
					</p>
